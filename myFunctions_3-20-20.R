...
#---------------------------------------------------    
calculate_stuff() #checking this function to make sure it works with default values

# --------------------------------------------------
# FUNCTION summarize_output
# description: pull elements from model summary list
# inputs: list from summary calls of lm
...
summarize_output <- function(z=NULL) {
  ...
  return(z$residuals) #whether or not z is null, we will return the residuals
...
#---------------------------------------------------
graph_results() #often won't get an error when compiling the function, only when running it
